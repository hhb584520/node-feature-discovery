...
- [*local* feature source](#local-feature-source) of nfd-worker creates
  labels by executing hooks and reading files
- [*custom* feature source](#custom-feature-source) of nfd-worker creates
...
configuration of the [*custom* feature source](#custom-feature-source).
